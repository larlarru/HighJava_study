...
public class URLTest01 {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		// https://ddit.or.kr:80/indexhtml?ttt=123
		
		URL url1 = new URL("https://ddit.or.kr:80/indexhtml?ttt=123");
		//URL url2 = new URL("http", "ddit.or.kr", 80, "indexhtml?ttt=123");
		...
		System.out.println("https://ddit.or.kr:80/indexhtml?ttt=123");
