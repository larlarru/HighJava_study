...
public class DeadeokHotel {
	...
	public DeadeokHotel() {
		...
		// 객실 초기화
//		hotelMap.put(201, new Room(2001, "싱글룸"));
		for (int i = 2; i <= 4; i++) {
...
//			return;
			...
			// 입력받은 객실의 투수객 명단에 입력받은 이름을 저장한다.
			hotelMap.get(roomNum).setGuestName(name);
			
			System.out.println(name + "씨가 " + roomNum + "호 객실을 체크인 하셨습니다.");
	...
	private void checkOut() {
		...
		System.out.println(roomNum + "호 객실의" + name + "님이 체크아웃을 완료하였습니다.");
	...
	private void showRoom() {
		...
		//	방벊를 순서대로 나오게 하기 위해서 방번호(Map의 key값)만 List에 넣어서 정렬하여 사용한다.
		...
		System.out.println("----------------------------------------------");
		System.out.println("방번호\t방종류\t투수객 이름");
		System.out.println("----------------------------------------------");
