 ...
 * - 열거형 선언하기
 * 	방법1)
 * 		enum 열거형이름{ 상수명1, 상수명2, ......} <-여기에는 ;이 안붙는다.
 * 		
 * 	방법2)
 * 		enum 열거형이름 {
 * 			상수명1(값들...),
 * 			상수명2(값들...),
 * 			...
 * 			상수명n(값들...); <-여기는 ;가 붙는데 이유는 다음에도 할것이 있다는 의미이다.
 * 
 ...
 * 			// 열거형의 생성자는 묵시적으로 private이다. <-- private로 하면 에러난다.
 * 			
...
public class EnumTest {
	...
	public enum Season {
		...
		private int startMonth;	// 값들이 저장될 변수
		private String endMonth;
		
		// 생성자
		Season(int sMonth, String eMont){	// private Season(int sMonth, String eMont){}와 같다.
			startMonth = sMonth; // 초기화
			endMonth = eMont;	// 초기화
		}
	...
	public static void main(String[] args) {
		...
		*/
		...
		switch(mycol) {
//			case Color.Red // 뭐 이런식으로 지으면 오류난다.
